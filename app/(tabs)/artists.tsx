  ...
  return (
    <SafeAreaView style={styles.safeAreaViewContainer}>
      <ScrollView ref={scrollViewRef} style={styles.container}>
        {artists.map(
          ({ id, image, name, bio, duration, style }, index) => {
            return (
